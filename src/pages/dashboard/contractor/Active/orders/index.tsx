...
// --- Navigation Component (Styled like your example) ---
...
function ContractorActiveOrdersPageContainer() {
  ...
  return (
    <>
      <DashboardHeader />
      <section className="container mx-auto mt-6 px-4 md:mt-12">
        <header>
          <ActiveFundiNav
            tabs={tabs}
            activeTab={activeTab}
...
export default ContractorActiveOrdersPageContainer;