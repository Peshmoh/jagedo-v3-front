...
const ProfessionalSubmission = ({ response }: ContractorSubmissionProps) => {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      navigate("/dashboard/professional?tab=bid");
    } catch (error: any) {
  ...
  const tabs = [
    ...
    { key: "fees", name: "Professional Fees" },
          ...
          {!isReadOnly && (
            <div className="mt-8 flex flex-col items-center bg-white p-8">
              ...
              <p className="text-sm text-gray-600 mt-4 mb-6 text-center max-w-md">
                Failure to adhere to the Professional agreement and stipulated timelines will lead to
                  ...
                  <div className="bg-white p-6 rounded-lg border">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Professional Fees Subtotal:</span>
